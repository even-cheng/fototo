...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: Bundle.main.bundleIdentifier ?? "com.even-cheng.photo", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: Bundle.main.bundleIdentifier ?? "com.even-cheng.photo", account: "userIdentifier").deleteItem()
        } catch {
